...
{
    //Screen that controls the wrap-around of characters leaving the screen and other on screen exit events

    //"Ghosts" are used to make the wrap-around smooth. 
    [SerializeField] private Transform ghostPrefab;
    //Variables for non-character sprites, sprites that don't use ghosts, and for sprites that disappear on their own and not when leaving the screen
    [SerializeField] private bool isCharacter, autoLeave, selfDestruct;
    ...
    private void PositionGhosts()
    {
        ...
        // All ghosts should have the same rotation as the main sprite
    ...
    {
        //Checking if any ghosts' middle point has entered the screen
