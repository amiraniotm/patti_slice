...
public class GhostMovement : MonoBehaviour
{
    ...
    private SpriteRenderer spriteRenderer, originalSpriteRenderer;

    private void Awake()
    {
        spriteRenderer = GetComponent<SpriteRenderer>();
    }
    // Called from original object screenwrap after it creates the ghosts and gives them reference
    ...
    private void FollowOriginal()
    {
        ...
        // Preventing ghosts from following when original is unassigned, defeated or spawning
        if(originalCharacter != null && !originalCharacter.isDefeated && !originalCharacter.isSpawning &&
